...
project.pledges.create!(name: "Nicole", email: "nicole@gmail.com", amount: 25.00, comment: "Great project!")
project.pledges.create!(name: "Mike", email: "mike@gmail.com", amount: 50.00, comment: "IPO now!")